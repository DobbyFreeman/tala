...
const handleYesClick = () => {
  question.innerHTML = "Yeahhhhhhhhhhh! See you on February 14!!";
...
const handleNoMouseOver = () => {
  ...
  gif.src = "https://media.giphy.com/media/5MxFJWDSm3boe6wigL/giphy.gif"
...
yesBtn.addEventListener("mouseover", ()=>{gif.src = "https://media.giphy.com/media/UMon0fuimoAN9ueUNP/giphy.gif";
});
